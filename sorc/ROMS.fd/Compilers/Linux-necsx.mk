# svn $Id: Linux-necsx.mk 1120 2022-04-08 19:14:36Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
ifdef USE_PIO
       PIO_INCDIR ?= /opt/necsxsoft/openmpi/pio/include
       PIO_LIBDIR ?= /opt/necsxsoft/openmpi/pio/lib
           FFLAGS += -I$(PIO_INCDIR)
             LIBS += -L$(PIO_LIBDIR) -lpiof -lpioc

   PNETCDF_INCDIR ?= /opt/necsxsoft/openmpi/pnetcdf/include
   PNETCDF_LIBDIR ?= /opt/necsxsoft/openmpi/pnetcdf/lib
           FFLAGS += -I$(PNETCDF_INCDIR)
             LIBS += -L$(PNETCDF_LIBDIR) -lpnetcdf
endif

ifdef USE_SCORPIO
       PIO_INCDIR ?= /opt/necsxsoft/openmpi/scorpio/include
       PIO_LIBDIR ?= /opt/necsxsoft/openmpi/scorpio/lib
           FFLAGS += -I$(PIO_INCDIR)
             LIBS += -L$(PIO_LIBDIR) -lpiof -lpioc
...
ifdef USE_NETCDF4
    ...
    NETCDF_INCDIR ?= /opt/necsxsoft/serial/netcdf3/include
    NETCDF_LIBDIR ?= /opt/necsxsoft/serial/netcdf3/lib
      NETCDF_LIBS ?= -lnetcdf
...
ifdef USE_HDF5
      HDF5_INCDIR ?= /opt/necsxsoft/serial/hdf5/include
      HDF5_LIBDIR ?= /opt/necsxsoft/serial/hdf5/lib
