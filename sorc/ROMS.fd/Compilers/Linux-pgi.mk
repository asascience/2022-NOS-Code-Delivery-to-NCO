# svn $Id: Linux-pgi.mk 1120 2022-04-08 19:14:36Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
ifdef USE_PIO
       PIO_INCDIR ?= /opt/pgisoft/openmpi/pio/include
       PIO_LIBDIR ?= /opt/pgisoft/openmpi/pio/lib
           FFLAGS += -I$(PIO_INCDIR)
             LIBS += -L$(PIO_LIBDIR) -lpiof -lpioc

   PNETCDF_INCDIR ?= /opt/pgisoft/openmpi/pnetcdf/include
   PNETCDF_LIBDIR ?= /opt/pgisoft/openmpi/pnetcdf/lib
           FFLAGS += -I$(PNETCDF_INCDIR)
             LIBS += -L$(PNETCDF_LIBDIR) -lpnetcdf
endif

ifdef USE_SCORPIO
       PIO_INCDIR ?= /opt/pgisoft/openmpi/scorpio/include
       PIO_LIBDIR ?= /opt/pgisoft/openmpi/scorpio/lib
           FFLAGS += -I$(PIO_INCDIR)
             LIBS += -L$(PIO_LIBDIR) -lpiof -lpioc
