      MODULE mod_arrays
!
!svn $Id: mod_arrays.F 1099 2022-01-06 21:01:01Z arango $
!================================================== Hernan G. Arango ===
...
!
      DO ng=1,Ngrids
        DO thread=MyRank,MyRank
          CALL wclock_on (ng, iNLM, 1, 132, MyFile)
        END DO
!$OMP BARRIER
      END DO
!
...
!
      DO ng=1,Ngrids
        DO thread=MyRank,MyRank
          CALL wclock_off (ng, iNLM, 1, 227, MyFile)
        END DO
!$OMP BARRIER
      END DO
!
...
!
      DO ng=1,Ngrids
        DO thread=MyRank,MyRank
          CALL wclock_on (ng, iNLM, 1, 349, MyFile)
        END DO
!$OMP BARRIER
      END DO
!
...
!
      DO ng=1,Ngrids
        DO thread=MyRank,MyRank
          CALL wclock_off (ng, iNLM, 1, 417, MyFile)
        END DO
!$OMP BARRIER
      END DO
!
