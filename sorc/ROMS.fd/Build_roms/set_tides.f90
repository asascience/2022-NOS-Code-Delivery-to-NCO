...
!
!svn $Id: set_tides.F 1099 2022-01-06 21:01:01Z arango $
!================================================== Hernan G. Arango ===
!  Copyright (c) 2002-2022 The ROMS/TOMS Group        Robert Hetland   !
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 11, 59, MyFile)
     ...
     &                     TIDES(ng) % UV_Tminor,                       &
     &                     TIDES(ng) % Tperiod)
      CALL wclock_off (ng, iNLM, 11, 109, MyFile)
!
      RETURN
