     ...
     &                      Fout)
!
!svn $Id: get_3dfld.F 1099 2022-01-06 21:01:01Z arango $
!================================================== Hernan G. Arango ===
...
!
  10  FORMAT (' GET_3DFLD - Illegal output type, io_type = ',i0)
!
      RETURN
...
!
     ...
     &                            start = (/Trec/),                     &
     &                            total = (/1/))
            IF (FoundError(exit_flag, NoError, 298, MyFile)) THEN
...
!
     ...
     &                              total = (/1/))
              ...
              Fmax=Fval
            END IF
            IF (FoundError(exit_flag, NoError, 371, MyFile)) THEN
              IF (Master) THEN
