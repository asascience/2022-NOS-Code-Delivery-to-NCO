     ...
     &                      Fout)
!
!svn $Id: get_ngfld.F 1099 2022-01-06 21:01:01Z arango $
!================================================== Hernan G. Arango ===
...
!
  10  FORMAT (' GET_NGFLD - Illegal output type, io_type = ',i0)
!
      RETURN
...
!-----------------------------------------------------------------------
!
      IF (FoundError(exit_flag, NoError, 179, MyFile)) RETURN
!
...
!
     ...
     &                            start = (/Trec/),                     &
     &                            total = (/1/))
            IF (FoundError(exit_flag, NoError, 270, MyFile)) THEN
...
!
     ...
     &                              total = (/Iend-Istr+1,Jrec,1/))
            END IF
            IF (FoundError(exit_flag, NoError, 323, MyFile)) THEN
