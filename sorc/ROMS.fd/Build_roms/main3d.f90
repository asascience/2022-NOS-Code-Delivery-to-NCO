...
!
!svn $Id: main3d.F 1099 2022-01-06 21:01:01Z arango $
!=======================================================================
...
!
          ...
          IF (FoundError(exit_flag, NoError, 178, MyFile)) RETURN
...
!$OMP BARRIER
            END DO
            IF (FoundError(exit_flag, NoError, 226, MyFile)) RETURN
!
!-----------------------------------------------------------------------
...
!$OMP END MASTER
!$OMP BARRIER
              IF ((FoundError(exit_flag, NoError, 525, MyFile)).or.     &
