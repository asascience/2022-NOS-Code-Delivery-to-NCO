...
!
!svn $Id: hypoxia_srm_inp.h 1099 2022-01-06 21:01:01Z arango $
!================================================== Hernan G. Arango ===
      ...
      DO WHILE (.TRUE.)
        ...
        IF (status.gt.0) THEN
          SELECT CASE (TRIM(KeyWord))
            ...
            CASE ('ResRate')
              Npts=load_r(Nval, Rval, Ngrids, ResRate)
            CASE ('TNU2')
...
!
     ...
     &            'Number of iterations for nonlinear convergence.'
            WRITE (out,70) ResRate(ng), 'ResRate',                      &
...
!
  ...
  50  FORMAT (/,/,' Hypoxia-SRM Parameters, Grid: ',i2.2,               &
     &        /,  ' ================================',/)
