...
!
!svn $Id: set_data.F 1099 2022-01-06 21:01:01Z arango $
!================================================== Hernan G. Arango ===
...
!
     ...
     &                     update)
      IF (FoundError(exit_flag, NoError, 789, MyFile)) RETURN
!
!=======================================================================
...
!
     ...
     &                      update)
            IF (FoundError(exit_flag, NoError, 1019, MyFile)) RETURN
          END IF
!
...
!
     ...
     &                      update)
            IF (FoundError(exit_flag, NoError, 1055, MyFile)) RETURN
          END IF
!
...
!
     ...
     &                      BOUNDARY(ng) % v_west,                      &
     &                      update)
            IF (FoundError(exit_flag, NoError, 1112, MyFile)) RETURN
          END IF
!
     ...
     &                      BOUNDARY(ng) % u_east,                      &
     &                      update)
            IF (FoundError(exit_flag, NoError, 1121, MyFile)) RETURN
          END IF
!
     ...
     &                      BOUNDARY(ng) % v_east,                      &
     &                      update)
            IF (FoundError(exit_flag, NoError, 1130, MyFile)) RETURN
          END IF
!
...
!
     ...
     &                       CLIMA(ng)%ubarclm,                         &
     &                       update)
        IF (FoundError(exit_flag, NoError, 1255, MyFile)) RETURN
!
...
!
     ...
     &                         CLIMA(ng)%tclm (:,:,:,ic),               &
     &                         update)
          IF (FoundError(exit_flag, NoError, 1306, MyFile)) RETURN
        END IF
      END DO
!
      RETURN
