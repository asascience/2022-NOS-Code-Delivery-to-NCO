      MODULE mod_strings
!
!svn $Id: mod_strings.F 1099 2022-01-06 21:01:01Z arango $
!================================================== Hernan G. Arango ===
...
!
        ...
        character (len=80)  :: my_fort = "ftn-intel"
        character (len=80)  :: my_fc = "/opt/cray/pe/craype/2.7.10/bin/ftn"
        character (len=512) :: my_fflags = "-fp-model precise -ip -O3 -free"
!
        character (len=256) :: Adir = "/lfs/h1/nos/nosofs/noscrub/aijun.zhang/code_delivered2NCO/nosofs.v3.5.0_4NCO/sorc/ROMS.fd"
        character (len=256) :: Hdir = "/lfs/h1/nos/nosofs/noscrub/aijun.zhang/code_delivered2NCO/nosofs.v3.5.0_4NCO/sorc/ROMS.fd/ROMS/Include"
        character (len=256) :: Hfile = "cbofs.h"
        character (len=256) :: Rdir = "/lfs/h1/nos/nosofs/noscrub/aijun.zhang/code_delivered2NCO/nosofs.v3.5.0_4NCO/sorc/ROMS.fd"
!
