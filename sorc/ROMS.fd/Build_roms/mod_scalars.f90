      MODULE mod_scalars
!
!svn $Id: mod_scalars.F 1118 2022-03-28 21:16:14Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      IF (allocated(blk_ZQ))            deallocate ( blk_ZQ )
      IF (allocated(blk_ZT))            deallocate ( blk_ZT )
      IF (allocated(blk_ZW))            deallocate ( blk_ZW )
