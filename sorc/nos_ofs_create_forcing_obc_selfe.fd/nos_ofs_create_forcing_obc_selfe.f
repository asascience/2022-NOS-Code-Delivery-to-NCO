...
13      read(40,'(a200)',end=15)BUFFER
     ...
     1	    'vertical parameters KBm and KB are not consistent' 
            WRITE(*,*)'FATAL ERROR: check main ctl and vgrid files'
	    STOP
	  ENDIF 
...
C  ----------------------------------------------------------------------------
	 ...
	 N0=1
	 DO N=1,NTR(I)
	   IF (WL_OBS(I,N) .LE. -99999.9) CYCLE 
