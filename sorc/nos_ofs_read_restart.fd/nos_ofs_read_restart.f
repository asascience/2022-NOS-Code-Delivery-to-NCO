...
!      PRINT *,trim(VNAME),ocean_time,NTIMES
	...
	write(*,*)'initial time= ',day_hotrestart
	write(*,*)'current time= ',day_start
C    Comment out the following because DA runs a 3-day window
C	write(*,*)'redefine restart time= day_start - 2'
C        day_hotrestart=day_start-2.0  !allow to search 2 days backward
C	CHANGE_TIME=.TRUE.
C	COLD_START="T"
         ntimes=0
      ENDIF
...
100   FORMAT(I4.4,3I2.2,2x,I10,f12.4,2x,F12.4)		     
