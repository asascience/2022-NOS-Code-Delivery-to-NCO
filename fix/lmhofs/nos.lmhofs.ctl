...
########################################################
export GRIDFILE=nos.lmhofs.grid.dat
export RIVER_CTL_FILE=nos.lmhofs.river.ctl
export RIVER_CLIM_FILE=nos.ofs.river.clim.usgs.nc
export OBC_CTL_FILE=nos.lmhofs.obc.ctl
export OBC_CLIM_FILE=nos.ofs.clim.WOA05.nc
export STA_OUT_CTL=nos.lmhofs_station.dat
export VGRID_CTL=nos.lmhofs.vgrid.dat
export RUNTIME_CTL=nos.lmhofs.fvcom.nml
export CORRECTION_STATION_CTL=nos.lmhofs.wlobc.correction.ctl
export WL_OFFSET_OLD=nos.lmhofs.wlobc.correction.old
export RESIDUAL_CTL=nos_lmhofs_residual_calculation.ctl
export STA_EDGE_CTL=nos.lmhofs_station_edge.dat
########################################################
...
export RIVER_NAMELIST=nos.lmhofs.nmelist.nml
export CORIOLISFILE=nos.lmhofs_cor.dat
export DEPTHFILE=nos.lmhofs_dep.dat
export RUNGRIDFILE=nos.lmhofs_grd.dat
export MODELOBCFILE=nos.lmhofs_obc.dat
export SIGMA_LEVEL=nos.lmhofs_sigma.dat
export SPONGEFILE=nos.lmhofs_spg.dat
export STATIONFILE=nos.lmhofs_station.dat
export InputNodeFile=nos.lmhofs.node.dat
export InputNode2LFile=nos.lmhofs.node.2LayerNd.dat
