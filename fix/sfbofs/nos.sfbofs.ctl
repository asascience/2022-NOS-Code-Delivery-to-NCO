# control files for sfbofs, which is read in by shell script 
...
########################################################
export GRIDFILE=nos.sfbofs.grid.dat
export HC_FILE_OBC=nos.sfbofs.HC.nc 
export HC_FILE_OFS=nos.sfbofs.HC.nc 
export RIVER_CTL_FILE=nos.sfbofs.river.ctl
export RIVER_CLIM_FILE=nos.ofs.river.clim.usgs.nc
export OBC_CTL_FILE=nos.sfbofs.obc.ctl
export OBC_CLIM_FILE=nos.ofs.clim.WOA05.nc
export STA_OUT_CTL=nos.sfbofs_station.dat
export VGRID_CTL=nos.sfbofs.vgrid.dat
export RUNTIME_CTL=nos.sfbofs.fvcom.nml
export HC_FILE_NWLON=nos.ofs.HC_NWLON.nc
export OBC_FILE_TEMPLATE=nos.sfbofs.obc.template.nc
export STA_EDGE_CTL=nos.sfbofs_station_edge.dat
########################################################
...
export RIVER_NAMELIST=nos.sfbofs.RIVERS_NAMELIST.nml
export CORIOLISFILE=nos.sfbofs.cor.dat
export DEPTHFILE=nos.sfbofs.dep.dat
export RUNGRIDFILE=nos.sfbofs.grd.dat
export MODELOBCFILE=nos.sfbofs.obc.dat
export SIGMA_LEVEL=nos.sfbofs.sigma.dat
export SPONGEFILE=nos.sfbofs.spg.dat
export STATIONFILE=nos.sfbofs.station.dat
export InputNodeFile=nos.sfbofs.node.dat
export InputNode2LFile=nos.sfbofs.node.2LayerNd.dat
