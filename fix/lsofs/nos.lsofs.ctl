# control files for lsofs, which is read in by shell script 
...
########################################################
export GRIDFILE=nos.lsofs.grid.dat
export RIVER_CTL_FILE=nos.lsofs.river.ctl
export RIVER_CLIM_FILE=nos.ofs.river.clim.usgs.nc
export OBC_CTL_FILE=nos.lsofs.obc.ctl
export OBC_CLIM_FILE=nos.ofs.clim.WOA05.nc
export STA_OUT_CTL=nos.lsofs_station.dat
export VGRID_CTL=nos.lsofs.vgrid.dat
export RUNTIME_CTL=nos.lsofs.fvcom.nml
export CORRECTION_STATION_CTL=nos.lsofs.wlobc.correction.ctl
export WL_OFFSET_OLD=nos.lsofs.wlobc.correction.old
export RESIDUAL_CTL=nos_lsofs_residual_calculation.ctl
export RESIDUAL_CANADA_CTL=nos_lsofs_residual_calculation_canada.ctl
...
export NELE=174015
export KBm=20
export DELT_MODEL=3.0
export EXTSTEP_SECONDS=5.0
export ISPLIT=2
...
export RIVER_NAMELIST=nos.lsofs.nmelist.nml
export CORIOLISFILE=nos.lsofs_cor.dat
export DEPTHFILE=nos.lsofs_dep.dat
export RUNGRIDFILE=nos.lsofs.grid.dat
export MODELOBCFILE=nos.lsofs_obc.dat
export SIGMA_LEVEL=nos.lsofs_sigma.dat
export SPONGEFILE=nos.lsofs_spg.dat
export STATIONFILE=nos.lsofs_station.dat
export InputNodeFile=nos.lsofs.node.dat
export InputNode2LFile=nos.lsofs.node.2LayerNd.dat
export NWM_REACHID_FILE=nos.lsofs.nwm.reach.dat
...
#export TOTAL_TASKS=420
#export TOTAL_TASKS=700
#export TOTAL_TASKS=840

export TOTAL_TASKS=560
export TOTAL_TASKS=512
