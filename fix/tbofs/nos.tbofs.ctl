# control files for TBOFS, which is read in by shell script 
...
export IGRD_MET=0
export IGRD_OBC=2
export BASE_DATE=2009010100
export TIME_START=2009092406
export MINLON=-84.0
export MINLAT=27.0
export MAXLON=-82.0 
export MAXLAT=29.0
...
########################################################
export GRIDFILE=nos.tbofs.romsgrid.nc
export HC_FILE_OBC=nos.tbofs.HC.nc 
export HC_FILE_OFS=nos.tbofs.roms.tides.nc 
export RIVER_CTL_FILE=nos.tbofs.river.ctl
export RIVER_CLIM_FILE=nos.ofs.river.clim.usgs.nc
export OBC_CTL_FILE=nos.tbofs.obc.ctl
export OBC_CLIM_FILE=nos.ofs.clim.WOA05.nc
export STA_OUT_CTL=nos.tbofs.stations.in
export RUNTIME_CTL=nos.tbofs.roms.in
export VARINFOFILE_ROMS=nos.ofs.roms.varinfo.dat
export HC_FILE_NWLON=nos.ofs.HC_NWLON.nc
export VGRID_CTL=nos.tbofs.vgrid.in
...
export NTILE_I=8     # Should match NtileI in nos.tbofs.roms.in
export NTILE_J=16    # Should match NtileJ in nos.tbofs.roms.in
