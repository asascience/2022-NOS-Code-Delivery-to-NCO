# control files for GOMOFS, which is read in by shell script 
...
export MAXLON=-60.0 
export MAXLAT=47.5
export THETA_S=5.0d0                     
export THETA_B=0.4d0                    
...
########################################################
export GRIDFILE=nos.gomofs.romsgrid.nc
export HC_FILE_OBC=nos.gomofs.HC.nc 
export HC_FILE_OFS=nos.gomofs.roms.tides.nc 
export RIVER_CTL_FILE=nos.gomofs.river.ctl
export RIVER_CLIM_FILE=nos.ofs.river.clim.usgs.nc
export OBC_CTL_FILE=nos.gomofs.obc.ctl
export OBC_CLIM_FILE=nos.ofs.clim.WOA05.nc
export STA_OUT_CTL=nos.gomofs.stations.in
export RUNTIME_CTL=nos.gomofs.roms.in
export VARINFOFILE_ROMS=nos.ofs.roms.varinfo.dat
export HC_FILE_NWLON=nos.ofs.HC_NWLON.nc
export VGRID_CTL=nos.gomofs.vgrid.in
########################################################
...
export Zob=0.0005d0
export TNU2=" 20.0d0  20.0d0                    ! m2/s"
export VISC2=50.0d0
export VISC4=0.0d0
...
export N_PROC=60
export NTILE_I=40    # Should match NtileI in nos.gomofs.roms.in
export NTILE_J=28    # Should match NtileJ in nos.gomofs.roms.in
