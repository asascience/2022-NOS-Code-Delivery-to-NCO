...
########################################################
export GRIDFILE=nos.cbofs.romsgrid.nc
export HC_FILE_OBC=nos.cbofs.HC.nc 
export HC_FILE_OFS=nos.cbofs.roms.tides.nc 
export RIVER_CTL_FILE=nos.cbofs.river.ctl
export RIVER_CLIM_FILE=nos.ofs.river.clim.usgs.nc
export OBC_CTL_FILE=nos.cbofs.obc.ctl
export OBC_CLIM_FILE=nos.ofs.clim.WOA05.nc
export STA_OUT_CTL=nos.cbofs.stations.in
export RUNTIME_CTL=nos.cbofs.roms.in
export VARINFOFILE_ROMS=nos.ofs.roms.varinfo.dat
export HC_FILE_NWLON=nos.ofs.HC_NWLON.nc
export VGRID_CTL=nos.cbofs.vgrid.in
########################################################
...
export NTILE_I=8    # Should match NtileI in nos.cbofs.roms.in
export NTILE_J=16    # Should match NtileJ in nos.cbofs.roms.in
export TOTAL_TASKS=$(($NTILE_I*$NTILE_J))
export BIO_MODULE=1
export RESPIRATE_RATE="nos.cbofs.respirate.nc"   # IF BIO_MODULE=1, it is needed, otherwise, it is not needed
