# control files for loofs, which is read in by shell script 
...
########################################################
export GRIDFILE=nos.loofs.grid.dat
export RIVER_CTL_FILE=nos.loofs.river.ctl
export RIVER_CLIM_FILE=nos.ofs.river.clim.usgs.nc
export OBC_CTL_FILE=nos.loofs.obc.ctl
export OBC_CLIM_FILE=nos.ofs.clim.WOA05.nc
export STA_OUT_CTL=nos.loofs_station.dat
export VGRID_CTL=nos.loofs.vgrid.dat
export RUNTIME_CTL=nos.loofs.fvcom.nml
export CORRECTION_STATION_CTL=nos.loofs.wlobc.correction.ctl
export WL_OFFSET_OLD=nos.loofs.wlobc.correction.old
export RESIDUAL_CTL=nos_loofs_residual_calculation.ctl
########################################################
...
export RIVER_NAMELIST=nos.loofs.nmelist.nml
export CORIOLISFILE=nos.loofs_cor.dat
export DEPTHFILE=nos.loofs_dep.dat
export RUNGRIDFILE=nos.loofs.grid.dat
export MODELOBCFILE=nos.loofs_obc.dat
export SIGMA_LEVEL=nos.loofs_sigma.dat
export SPONGEFILE=nos.loofs_spg.dat
export STATIONFILE=nos.loofs_station.dat
export InputNodeFile=nos.loofs.node.dat
export InputNode2LFile=nos.loofs.node.2LayerNd.dat
export NWM_REACHID_FILE=nos.loofs.nwm.reach.dat
