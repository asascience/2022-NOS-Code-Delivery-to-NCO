# control files for dbofs, which is read in by shell script 
...
########################################################
export GRIDFILE=nos.dbofs.romsgrid.nc
export HC_FILE_OBC=nos.dbofs.HC.nc 
export HC_FILE_OFS=nos.dbofs.roms.tides.nc 
export RIVER_CTL_FILE=nos.dbofs.river.ctl
export RIVER_CLIM_FILE=nos.ofs.river.clim.usgs.nc
export OBC_CTL_FILE=nos.dbofs.obc.ctl
export OBC_CLIM_FILE=nos.ofs.clim.WOA05.nc
export STA_OUT_CTL=nos.dbofs.stations.in
export RUNTIME_CTL=nos.dbofs.roms.in
export VARINFOFILE_ROMS=nos.ofs.roms.varinfo.dat
export HC_FILE_NWLON=nos.ofs.HC_NWLON.nc
export VGRID_CTL=nos.dbofs.vgrid.in
########################################################
...
export DCRIT="0.20d0     !m"                 
export DSTART=151.0d0
export TIDE_START=0.0d0
export NTILE_I=8     # Should match NtileI in nos.dbofs.roms.in
export NTILE_J=16    # Should match NtileJ in nos.dbofs.roms.in
